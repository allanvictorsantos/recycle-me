...
function HomePage() {
  ...
  return (
    <main className="bg-white dark:bg-gray-900 transition-colors duration-300 font-sans overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-gray-900 via-gray-900/70 to-transparent flex items-center">
                <div className="container mx-auto px-6 md:px-12">
                  <div className="max-w-2xl text-white space-y-8">
                    ...
                    {/* Título com animação de flutuar suave */}
      ...
      {/* === O CLUBE (Com Background mais vivo) === */}
      <section id="clube-recycleme" className="py-24 bg-gray-900 relative overflow-hidden">
        {/* Blobs de luz no fundo mais intensos */}
        <div className="absolute top-[-20%] right-[-10%] w-[600px] h-[600px] bg-brand-green/20 rounded-full blur-[120px] pointer-events-none mix-blend-screen animate-pulse-slow"></div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* Card 2 */}
            <div className="group bg-gray-800/60 backdrop-blur-xl border border-gray-700/50 p-10 rounded-[2.5rem] hover:border-blue-500/50 transition-all duration-500 hover:-translate-y-3 shadow-2xl relative overflow-hidden">
               ...
               <div className="relative z-10">
                  <div className="w-24 h-24 bg-gradient-to-br from-blue-500 to-indigo-700 rounded-3xl flex items-center justify-center mb-8 shadow-lg shadow-blue-500/20 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500">
                    <i className="fas fa-shopping-bag text-4xl text-white drop-shadow"></i>
                  </div>
                  <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-blue-400 transition-colors">Marketplace</h3>
                  <p className="text-gray-400 leading-relaxed font-medium">Seus pontos viram moeda. Troque por vouchers no iFood, Uber, Amazon e descontos em mercados locais.</p>
               </div>
            </div>
      ...
      {/* === COMO FUNCIONA (Com Glow no Device) === */}
      <section id="como-funciona" className="py-24 bg-gray-50 dark:bg-gray-900 transition-colors duration-300 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            ...
            <div className="w-full lg:w-1/2 space-y-12">
              ...
              <Link to="/cadastro" className="inline-flex items-center gap-3 px-10 py-4 bg-brand-green text-white rounded-full font-bold text-lg shadow-lg shadow-brand-green/30 hover:shadow-brand-green/50 hover:-translate-y-1 transition-all btn-glow-green relative overflow-hidden group">
      ...
      {/* === O QUE ACEITAMOS (Com Efeito de Brilho ao Passar o Mouse) === */}
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            {[
              ...
              // Adicionado 'group/card' e o efeito de brilho 'before:absolute...'
